<template>
  <div>
    <div v-if="$page.props.flash.success && show" class="fixed max-w-3xl z-50 right-2 top-14 py-4 px-4 bg-green-500 rounded-lg
    shadow-lg  flex space-x-4 divide-x divide-tertiary text-tertiary animate-fade-in-down">
    ...
    <div v-if="($page.props.flash.error || Object.keys($page.props.errors).length > 0) && show" class="fixed max-w-3xl z-50 right-2 top-14 py-4 px-4 bg-red-500 rounded-lg
    shadow-lg  flex space-x-4 divide-x divide-tertiary text-tertiary animate-fade-in-down">
      <div class="flex items-center">
