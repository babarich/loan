...
const classes = computed(() => {
    return props.active
        ? 'inline-flex items-center px-4 py-3 w-full rounded-sm  bg-gray-100 border-l-2 border-primary text-primary  text-sm font-medium leading-5  transition duration-150 ease-in-out'
