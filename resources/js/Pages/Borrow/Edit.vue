            ...
            <Stepper v-model:activeStep="active">
                ...
                <svg
                  ...
                  />
                                        ...
                                        <button
                                            type="button"
                                            class="relative overflow-hidden ml-5 bg-primary py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-100 hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                        >
                                            <input
                                                type="file"
...
const form = useForm({
    ...
    file: null,
    birth: formatDate(props.customer.date_birth),
    ...
    working:props.customer.working_status,
    business:props.customer.business_name,
    image: props.customer.filename,
    image_url: props.customer.filename,
});
...
function onUpdate(){
    loading.value = true
    form.post(route('borrow.update', props.customer.id),{
        onSuccess:()=>{
            loading.value = false
        },
        onError:()=>{
