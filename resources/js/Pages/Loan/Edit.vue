    ...
    <AppLayout>
        ...
        <div class="h-full p-5 md:p-8">
            <div class="flex flex-col md:flex-row items-center justify-between  pb-5 md:pb-7">
                    ...
                    <div>
                        <a :href="route('loan.index')" class="px-4 text-sm flex text-gray-100 bg-primary p-2 rounded">
...
const props = defineProps({
    errors:Object,loan:Object,borrowers:Object, guarantors:Object, products:Object
});
...
const form = useForm({
    release_date: props.loan.loan_release_date,
    product: props.loan.loan_product,
    principle: props.loan.principle_amount,
    interest:props.loan.total_interest,
    interest_type:props.loan.interest_type,
    percent:props.loan.interest_percentage,
    interest_amount:props.loan.interest_amount,
    interest_method:props.loan.interest_method,
    loan_duration:props.loan.loan_duration,
    description:props.loan.description,
    duration_type:props.loan.duration_type,
    payment_cycle:props.loan.payment_cycle,
    number_payments:props.loan.payment_number,
    guarantor:props.loan.guarantor_id,
    total_interest:props.loan.total_interest,
    payment: props.loan.disbursement,
    borrower:props.loan.borrower_id
...
function onUpdate(){
    loading.value = true
    form.post(route('loan.update', props.loan.id),{
        onSuccess:()=>{
            loading.value = false
        },
        onError:()=>{
