        ...
        <div class="rounded bg-white p-5 shadow md:p-8 w-full">
            ...
            <div class="bg-white overflow-x-auto">
                <table class="w-full text-sm whitespace-nowrap">
                    ...
                    <tr v-for="(mature,index) in matures.data" :key="index" class="odd:bg-gray-100 focus-within:bg-gray-100">
                        <td class="py-4 px-4 text-sm text-left border">
                            {{index + 1}}
                        </td>
                        <td class="py-4 px-4 text-sm text-left border">{{mature.reference}}</td>
                        <td class="py-4 px-4 text-sm text-left border">{{mature.name}}</td>
                        <td class="py-4 px-4 text-sm text-left border">{{mature.release}}</td>
                        <td class="py-4 px-4 text-sm text-left border">{{mature.maturity}}</td>
                        <td class="py-4 px-4 text-sm text-left border">{{mature.principal}}</td>
                        <td class="py-4 px-4 text-sm text-left border">{{mature.paid}}</td>
                        <td class="py-4 px-4 text-sm text-left border text-wrap">{{mature.balance}}</td>
                        <td class="py-4 px-4 text-sm text-left border">
                        <span class="bg-yellow-500 text-white p-2 rounded-md text-xs" v-if="mature.status === 'pending'">
                            Pending
                        </span>
